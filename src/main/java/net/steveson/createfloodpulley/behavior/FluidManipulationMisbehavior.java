...
public abstract class FluidManipulationMisbehavior extends BlockEntityBehaviour {
    ...
    List<FluidManipulationMisbehavior.BlockPosEntry> frontier;
    ...
    protected int comparePositions(FluidManipulationMisbehavior.BlockPosEntry e1, FluidManipulationMisbehavior.BlockPosEntry e2) {
    ...
    protected Fluid search(Fluid fluid, List<FluidManipulationMisbehavior.BlockPosEntry> frontier, Set<BlockPos> visited,
                           BiConsumer<BlockPos, Integer> add, boolean searchDownward) throws FluidManipulationMisbehavior.ChunkNotLoadedException {
        Level world = getWorld();
        int maxBlocks = -1;
        ...
        for (i = 0; i < searchedPerTick && !frontier.isEmpty()
            ...
            FluidManipulationMisbehavior.BlockPosEntry entry = frontier.remove(0);
            ...
            for (Direction side : Iterate.directions) {
                ...
                frontier.add(new FluidManipulationMisbehavior.BlockPosEntry(offsetPos, entry.distance + 1));
            }
        }
